(ag_percept (percept_pobj ev18) (percept_pname isa) (percept_pval event))
...
(ag_percept (percept_pobj car1) (percept_pname distance_to_my_car) (percept_pval 11))
(ag_percept (percept_pobj car1) (percept_pname speed) (percept_pval 15))
