(ag_percept (percept_pobj ev23) (percept_pname isa) (percept_pval event))
(ag_percept (percept_pobj ev23) (percept_pname event_type) (percept_pval danger_zone))
...
(ag_percept (percept_pobj car1) (percept_pname distance_to_my_car) (percept_pval 1))
(ag_percept (percept_pobj car1) (percept_pname speed) (percept_pval 0))
(ag_percept (percept_pobj car2) (percept_pname distance_to_my_car) (percept_pval 3))
