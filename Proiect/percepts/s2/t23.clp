...
(ag_percept (percept_pobj cyclist1) (percept_pname rel_dist) (percept_pval 0))
(ag_percept (percept_pobj cyclist1) (percept_pname rel_pos) (percept_pval lateral_right))
