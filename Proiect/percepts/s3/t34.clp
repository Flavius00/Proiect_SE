(ag_percept (percept_pobj road1) (percept_pname status) (percept_pval exit_ramp))
(ag_percept (percept_pobj road1) (percept_pname curvature) (percept_pval sharp_right))
